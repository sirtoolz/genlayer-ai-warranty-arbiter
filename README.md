...
1. **Web Scraper:** To read product descriptions directly from the internet.
2. **AI Reasoning:** To determine if a user's complaint is logically valid based on those specs.
...
## 📁 Project Structure
- `/contracts`: Contains `warranty_arbiter.gpy` (The Intelligent Contract)
